      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="space-y-6">
          {services.map((service, index) => (
            ...
            >
              <div className="w-16 h-16 bg-secondary rounded-2xl flex items-center justify-center shrink-0 text-primary group-hover:bg-primary group-hover:text-background transition-colors duration-300">
